This branch is rebase from JDC AOSP to LOS 14.1
===========
<p align="center">
...
```bash
  repo init -u git://github.com/manishjvora/manifest.git -b LOS_AEX7.x --depth=1 --groups=all,-darwin,-x86,-mips,-exynos5
```
